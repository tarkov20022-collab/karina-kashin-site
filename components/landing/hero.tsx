    ...
    <section className="relative overflow-hidden bg-secondary">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-5 pb-14 pt-32 md:px-10 md:pt-40 lg:py-44">
          ...
          <AnimatedFadeUp delay={0.4} className="mt-9 flex flex-wrap items-center gap-4">
            <a
              href="#contact"
          ...
          <AnimatedContainer className="mt-12 grid grid-cols-1 gap-6 border-t border-border/70 pt-8 sm:grid-cols-3" staggerDelay={0.08}>
            {stats.map((s) => (
